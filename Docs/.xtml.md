...
<body>
  <header>
    ...
    <p>Powered by Fadaka Blockchain, HD Wallet & GPT Assistant</p>
...
<section>
  ...
  <footer>
    Built by <a href="https://github.com/Web4application" target="_blank">Web4Application</a> © 2026
  </footer>

  <script>
    const backendURL = window.location.hostname.includes("localhost")
      ? "http://localhost:8000"
      : "https://web4app.webflow.io; // UPDATE THIS after backend deployment
